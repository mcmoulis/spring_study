package com.mcms.study.spring.batch.interceptor.test;
...
@ContextConfiguration(locations = { "classpath:META-INF/spring/interceptors-demo-context.xml", "classpath:META-INF/spring/batch-test-context.xml" })
